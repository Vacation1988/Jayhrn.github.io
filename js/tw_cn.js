...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const msgToTraditionalChinese = '<i class="fa-solid fa-earth-asia"></i><span>轉為繁體</span>' // 此處可以更改為你想要顯示的文字
  const msgToSimplifiedChinese = '<i class="fa-solid fa-earth-asia"></i><span>转为简体</span>' // 同上，但兩處均不建議更改
